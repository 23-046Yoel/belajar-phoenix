defmodule UpaTikPortal.Keluhans.Keluhan do
  ...
  @categories ~w(sso_gmail internet_wifi portal_sia hardware_fasilitas lainnya)
  ...
  schema "keluhans" do
    ...
    field :category, :string, default: "lainnya"
  ...
  def changeset(keluhan, attrs) do
    keluhan
    |> cast(attrs, [:subject, :description, :user_id, :category])
