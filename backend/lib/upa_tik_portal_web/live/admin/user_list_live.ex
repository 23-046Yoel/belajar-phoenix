          ...
          <table class="w-full text-left border-collapse">
            <thead class="bg-slate-50/50 border-b border-slate-100">
              <tr>
                ...
                <th class="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right">
                  Aktivitas
                </th>
              </tr>
            </thead>
                ...
                <tr class="hover:bg-slate-50/30 transition-all cursor-default">
                  <td class="px-10 py-8">
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        <p class="font-black text-slate-900 text-lg tracking-tight uppercase italic transition-colors group-hover:text-indigo-600">
                          {user.name}
                        </p>
                  ...
                  <td class="px-10 py-8 text-right">
                    <div class="flex flex-col items-end">
                      ...
                      <p class="text-xs font-bold text-slate-500">
                        {Calendar.strftime(user.updated_at, "%d %b %Y")}
                      </p>
                    </div>
                  </td>
                </tr>
