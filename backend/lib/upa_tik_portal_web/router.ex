defmodule UpaTikPortalWeb.Router do
  ...
  scope "/admin", UpaTikPortalWeb.Admin do
    ...
    live "/tabel-users", TabelUsersLive, :index
    live "/logs", AuditLogLive, :index

    get "/reports/requests", ReportController, :export_requests
    get "/reports/keluhans", ReportController, :export_keluhans
    get "/reports/all", ReportController, :export_all
