  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-slate-50 flex flex-col justify-center items-center py-12 px-4 relative overflow-hidden">
      ...
      <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none w-full h-full flex justify-center items-center">
        <div class="absolute w-[800px] h-[800px] rounded-full bg-indigo-100/40 blur-[120px] mix-blend-multiply opacity-70 animate-pulse transition-all duration-1000">
        </div>

        <div class="absolute translate-x-1/2 translate-y-1/4 w-[600px] h-[600px] rounded-full bg-blue-50/60 blur-[100px] mix-blend-multiply opacity-50">
        </div>
      </div>
        ...
        <div class="bg-white p-10 sm:p-14 shadow-2xl shadow-indigo-100/40 rounded-[2.5rem] border border-slate-100 backdrop-blur-sm group">
          ...
          <div class="space-y-6">
            <div class="text-center">
              ...
              <p class="text-[10px] uppercase font-bold tracking-[0.1em] text-slate-400 mt-1">
                Gunakan akun Google universitas Anda
              </p>
            </div>
            ...
            <div>
              ...
              >
                <svg
                  class="h-5 w-5 transition-transform group-hover:scale-125 duration-300"
                  viewBox="0 0 24 24"
                >
                  <path
                    fill="#4285F4"
