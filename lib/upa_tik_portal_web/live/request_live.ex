              ...
              <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <button
                    type="button"
                    phx-click="set_type"
                    phx-value-type="aktivasi"
                    class={[
                      "relative group p-6 rounded-3xl border-2 text-left transition-all duration-300",
                      if(@request_type == "aktivasi",
                        do: "border-indigo-600 bg-indigo-50/50 shadow-lg shadow-indigo-100",
                        else: "border-slate-100 hover:border-indigo-200 hover:bg-slate-50"
                      )
                    ]}
                  >
                    <div class={[
                    ...
                    <p class="text-sm text-slate-500 mt-1 font-medium leading-relaxed">
                      Belum pernah memiliki akun email institusi @mahasiswa.trunojoyo.ac.id
                    </p>
                  </button>
                  <button
                    type="button"
                    phx-click="set_type"
                    phx-value-type="reset"
                    class={[
                      "relative group p-6 rounded-3xl border-2 text-left transition-all duration-300",
                  ...
                  >
                    ...
                    <p class="text-sm text-slate-500 mt-1 font-medium leading-relaxed">
                      Lupa password atau terkendala login ke akun email kampus yang sudah ada.
                    </p>
                  </button>
                </div>
              </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div class="space-y-3">
                    <label class="block text-xs font-black text-slate-400 uppercase tracking-widest ml-1">
                      ...
                      <span :if={@request_type == "reset"} class="text-rose-500">*</span>
                    </label>
                    <div
                      class="border-4 border-dashed border-slate-100 rounded-[2rem] p-8 text-center hover:border-indigo-200 hover:bg-slate-50 transition-all group relative"
