    ...
    <div class="max-w-4xl mx-auto space-y-12 pb-20">
      ...
      <%= if @submitted do %>
        <div class="bg-white border border-slate-100 rounded-[2.5rem] p-16 text-center shadow-2xl shadow-indigo-100/50 animate-in fade-in zoom-in duration-500">
          ...
          <p class="text-slate-500 mb-10 text-lg font-medium">Akun Gmail sedang proses, silakan cek kotak Gmail yang Anda lampirkan untuk mendapatkan notifikasi dari admin.</p>
      ...
      <% else %>
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
          <form id="request-form" phx-submit="submit" phx-change="update_field" class="p-8 sm:p-14 space-y-12">
            ...
            <div class="space-y-8 pt-10 border-t border-slate-100">
              <div class="flex items-center gap-3">
                <span class="w-8 h-8 bg-indigo-600 text-white rounded-lg flex items-center justify-center font-bold text-sm">04</span>
                <label class="text-lg font-black text-slate-900 tracking-tight uppercase">Berkas Pendukung</label>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-3">
                  <label class="block text-xs font-black text-slate-400 uppercase tracking-widest ml-1">
                    Kartu Hasil Studi (KHS) <span :if={@request_type == "reset"} class="text-rose-500">*</span>
                  </label>
                  <div class="border-4 border-dashed border-slate-100 rounded-[2rem] p-8 text-center hover:border-indigo-200 hover:bg-slate-50 transition-all group relative"
