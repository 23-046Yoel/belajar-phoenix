      ...
      <nav class="bg-white border-b border-slate-200 shadow-sm">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div class="flex gap-4 items-center">
            <a href="/admin" class="text-sm text-slate-500 hover:text-blue-600 transition-colors">Dashboard</a>
            <a href="/admin/pengajuan" class="text-sm text-slate-500 hover:text-blue-600 transition-colors">Pengajuan</a>
            <a href="/admin/keluhan" class="text-sm font-semibold text-blue-600">Keluhan</a>
